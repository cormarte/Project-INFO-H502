...
MeshFileReader* MeshFileReader::instance = 0;
...
MeshFileReader* MeshFileReader::getInstance() {

	if (instance == 0) {

		instance = new MeshFileReader();
	}
...
void MeshFileReader::readFile(const char* path, vector<vec4>& vertices, vector<vec3>& normals, vector<GLushort>& elements) {
